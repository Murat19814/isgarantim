...
export async function createServiceRequest(
  ...
  return prisma.serviceRequest.create({
    data: {
      ...
      bulkQuantity: input.bulkQuantity ?? null,
      orgType: input.orgType || null,
      prefVerifiedProvider: input.prefVerifiedProvider ?? false,
      prefWomanProvider: input.prefWomanProvider ?? false,
      prefReviewedProvider: input.prefReviewedProvider ?? false,
      prefTeamProvider: input.prefTeamProvider ?? false,
      onBehalf: input.onBehalf ?? false,
      onBehalfName: input.onBehalf ? input.onBehalfName || null : null,
      onBehalfPhone: input.onBehalf ? input.onBehalfPhone || null : null,
